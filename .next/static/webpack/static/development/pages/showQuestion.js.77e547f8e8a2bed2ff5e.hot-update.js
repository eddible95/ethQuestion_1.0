...
function (_Component) {
  ...
  function QuestionRow(props) {
    ...
    function () {
      ...
      /*#__PURE__*/
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee7(answerer) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 19:
                ...
                _context7.t1 = _ethereum_token__WEBPACK_IMPORTED_MODULE_22__["default"].methods;
                _context7.next = 24;
              ...
              case 28:
                logTransaction = Object(_utils_functions__WEBPACK_IMPORTED_MODULE_30__["logging"])("Approved An Answer for Question Titled: " + _this.state.summary[0]);
                _context7.next = 31;
                return _ethereum_factory__WEBPACK_IMPORTED_MODULE_25__["default"].methods.approveAnswer(_this.state.questionAddress, index, logTransaction).send({
                  from: account,
                  gasPrice: '0'
                });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(QuestionRow, [{
    ...
    value: function renderAnswers() {
      ...
      answers = Object(_utils_functions__WEBPACK_IMPORTED_MODULE_30__["sortingAnswers"])(answers, this.state.sorted); // Answering Phase no answers are shown
    ...
    value: function renderFilesUpload(files) {
      ...
      if (this.state.files_array.length == 0) {
        return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Container"], null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("input", {
          style: {
            display: 'none'
          },
          type: "file",
    ...
    value: function render() {
      ...
      if (this.state.login) {
        return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_26__["default"], {
          ...
          hidden: true
        }), this.renderQuestion(), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Divider"], {
          hidden: true
        }), this.renderFiles(), this.state.questionState == 1 ? react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Container"], null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Header"], {
          as: "h2",
          textAlign: "center"
        }, "Voting In Progress"), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("p", {
          style: {
            textAlign: 'center',
            fontSize: 20
          }
        }, "No answers can be submitted"), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Divider"], null)) : react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Header"], {
          as: "h2",
          textAlign: "center"
        }, "Submit Your Answers Here"), this.state.questionState == 1 ? null : react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Container"], null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("p", null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("b", null, "Note:"), " To include math equations, delimit the latex format with $$."), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("a", {
          style: {
            display: "table-cell"
          },
          href: "https://www.codecogs.com/latex/eqneditor.php",
          target: "_blank"
        }, "Link to Supported Latex Editor")), this.state.questionState == 1 ? null : this.renderAnswersForm(), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_15__["Button"], {
...
//# sourceMappingURL=showQuestion.js.77e547f8e8a2bed2ff5e.hot-update.js.map