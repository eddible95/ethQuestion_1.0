  ...
  function QuestionRow(props) {
    ...
    function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_2___default.a.mark(function _callee7(answerer) {
        var account, question, profile, answerList, i;
            ...
            switch (_context7.prev = _context7.next) {
              ...
              case 10:
                ...
                for (i = 0; i < answerList.length; i++) {
                  if (answerList[i][3] == answerer) {
                    console.log(answerList[i][3]);
                    console.log(i);
                  }
...
//# sourceMappingURL=showQuestion.js.1eb3d9cbd9a32b168091.hot-update.js.map